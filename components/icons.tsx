...
export const LightBulbIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-11.628 6.01 6.01 0 00-1.5-1.128 6.01 6.01 0 00-7.5 0 6.01 6.01 0 00-1.5 1.128 6.01 6.01 0 001.5 11.628v5.25M12 18h-2.25m4.5 0H12M12 18v-5.25" />
    </svg>
);
...
export const BuildingStorefrontIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.25m11.25 0H21.75M5.25 6.033c.264-.162.558-.29.875-.385A7.487 7.487 0 0112 4.5c2.138 0 4.133.722 5.67 1.908.32.22.653.403.997.545M5.25 6.033V18.75m13.5-12.717V18.75" />
    </svg>
);
...
export const StarIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.321h5.367a.563.563 0 01.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.528 5.001a.562.562 0 01-.84.622l-4.48-3.447a.563.563 0 00-.676 0L6.48 21.75a.562.562 0 01-.84-.622l1.528-5.001a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988h5.367a.563.563 0 00.475-.321L11.48 3.5z" />
    </svg>
);
